...
Now, the final line, `hashNav.triggerEvent();`, is called so that our new observer is alerted to any potential change. For more information on how to use the glorious trigger system in conjunction with the magical observer paradigm, read the [documentation](http://xunnamius.github.com/HashNav "It's really cool :D").
