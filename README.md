...
* Use the <a href="#PMI:TriggerEvent" title="Jump to it!">triggerEvent()</a> method whenever you register a new observer (or after you're finished regstering *all* your observers or initializing a page -- much more efficient, here's an <a href="#PMI:TriggerEvent" title="Jump to it!">example</a>).
	* If you're a cool professional who knows what (s)he is doing, you'll find times when you *don't* want to use <a href="#PMI:TriggerEvent" title="Jump to it!">triggerEvent()</a> after registering an observer or two! Ooh!
