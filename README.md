...
If you're in a hurry and just need some decent hash navigation, you could do something like:
...
For more information on how to use the glorious trigger system in conjunction with the magical observer paradigm, read the [documentation](http://xunnamius.github.com/HashNav "It's really cool :D").
...
*Check the change log for more information on releases!*g like this: