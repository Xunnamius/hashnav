window.addEvent('domready', function()
{
	...
	else
	{
		...
		console.warn('Page: Pro Tip #2 -> Use "args<argument1,argument2,...>" as strings (without the quotes, and no spaces between commas) if you want to feed in a comma separated list of values to a method as an argument outside of JSON notation. Can only be used properly on methods that accept only one argument as a parameter!');
		console.warn('Page: Pro Tip #3 -> Use "number<num>" as strings (without the quotes, replace num with your number) if you want to feed in a literal number into a method as an argument (doesn\'t work with JSON data). This is mainly for the number 0, which, in some browsers, is always interpreted as a string for some reason.');
		console.log('');
		console.log('---');
		console.log('');
