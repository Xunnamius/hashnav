...
window.addEvent('domready', function()
{
	...
	else
	{
		...
		if(hashNav.$_hidden_DOM_loaded)
		{
			...
			$('current-hash').observe({ page: false }, function(e)
			{
		...
		{
			console.warn('HashNav Class: The HashNav.DOM module has NOT been loaded yet! You can try again by typing "HNMODS.load.module(\'HashNav.DOM\');" into this console.');
			console.log('HashNav: Creating observer directly...');
			hashNav.registerObserver('main', { page: false }, function(e)
			{
		...
		console.log('Need an example to get ya started? Here, try typing this into your console: var h = new HashNav(); h.triggerEvent();');
