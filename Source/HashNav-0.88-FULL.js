...
(function() // Private
{
	var instance = null, history = [], observers = {}, version = 0.88, // Singleton
	utility = {
	...
	this.HashNav = new Class({
		...
		navigateTo: function(loc)
		{
			...
			else if(typeof(loc) == 'object') wlh = this.options.prefix + this.state.current + '&&' + utility.POTQS(loc);
		...
		getCurrent: function(){ return this.state.current; },
